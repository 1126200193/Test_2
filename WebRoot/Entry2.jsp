...
<body onload="createCode();">
	<form action="ud2.jsp" method="post" name="update" target="_self"
		...
		<table width="652" height="435" border="7" align="center"
			...
			<tr>
				<td colspan="2" align="center" bgcolor="#CAE1FF"
					style="font-size: 30px;"><strong>管 理 员 登 录 密 码 修 改</strong></td>
			</tr>
			<tr>
				<td width="149" align="right" bgcolor="#B0E0E6"
					style="font-size: 20px;"><label for="password2">&nbsp;账号：</label></td>
